...
type BatchDeploySyngentaOracleResult = {
    tx: TxSignBuilder;
    syngentaOraclePolicyId: PolicyId;
    scripts: {
        syngentaOracleMinting: MintingPolicy;
